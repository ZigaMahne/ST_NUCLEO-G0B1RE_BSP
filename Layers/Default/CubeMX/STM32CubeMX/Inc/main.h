...
#define ARD_A0_EXTI_IRQn EXTI0_1_IRQn
#define ARD_A1_Pin GPIO_PIN_1
#define ARD_A1_GPIO_Port GPIOA
#define ARD_A1_EXTI_IRQn EXTI0_1_IRQn
...
#define ARD_D12_EXTI_IRQn EXTI4_15_IRQn
