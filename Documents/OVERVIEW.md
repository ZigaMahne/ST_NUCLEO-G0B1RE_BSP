...
The **STMicroelectronics NUCLEO-G0B1RE Board Support Pack (BSP)**:
...
- Requires the [Device Family Pack (DFP) for the STM32G0 series](https://www.keil.arm.com/packs/stm32g0xx_dfp-keil).
...
By default the [Board Layers](https://github.com/Open-CMSIS-Pack/ST_NUCLEO-G0B1RE_BSP/tree/main/Layers) are configured for the Arm Compiler 6 (AC6). Using STM32CubeMX it can be reconfigured for a different compiler. To configure it for the GCC compiler execute these steps:
