/******************************************************************************
 * @file     vio_NUCLEO-G0B1RE.c
 * @brief    Virtual I/O implementation for board NUCLEO-G0B1RE
 * @version  V2.1.0
 * @date     17. July 2025
 ******************************************************************************/
/*
...
/*! \page vio_NUCLEO-G0B1RE Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED Green   (LD4)    | PA5

Note: The pin LED LD2 conflict with the pin SPI1_SCK on the board. The #define VIO_DISABLE_LD4 disables this LED.
*/
